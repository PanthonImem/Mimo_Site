...
def main():
    ...
    st.caption('This page is resource-intensive so the functionality is hide by default to lessen accidental load. \
    To use this page should tick the box below. ')
    flag_show = st.checkbox('Show PCA Plot Functionality')
