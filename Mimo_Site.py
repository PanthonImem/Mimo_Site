...
def main():
    ...
    st.write('I would like to hereby thank [PESDB](https://pesdb.net/pes2022/) for the data behind this project. While not officially a data sponsor,\
     PESDB set their website up in a way that is very friendly for enthusiasts to access and made this whole project possible. Please visit their website and watch some ads if you have time.')
